...
extern inline BOOL USBD_ReqGetStatus (void);
extern inline BOOL USBD_ReqSetClrFeature (U32 sc);
extern inline BOOL USBD_ReqSetAddress (void);
extern inline BOOL USBD_ReqGetConfiguration (void);
